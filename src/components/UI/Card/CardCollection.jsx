...
const CardCollection = ({ data: { img, title, price } }) => {

    return (
        <div className="w-[300px] rounded-t-[20px] overflow-hidden">

            <div className="py-[13px] px-[10px] bg-[#898989]">
                <img src={img} alt={title} className="object-cover" />
            </div>

            <div className="pt-[10px] pl-[12px] pr-[10px] bg-[#D9D9D9]">

                <div className="flex items-center gap-x-2 text-[16px] font-['InterMedium'] border-b-[1px] border-b-gray-400 pb-[12px]">
